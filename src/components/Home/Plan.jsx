    ...
    return (
        <div>
            <div className="hero min-h-screen bg-base-200">
                <div className="hero-content flex-col lg:flex-row gap-14 lg:gap-16">
                    <img src="https://i.ibb.co/sQ9VMwS/1692622481724-e-2147483647-v-beta-t-z-Vlx9-PTBRmxtecb0-PTCEAu-N8c4-G5-JRg-VYan0yw1-rk.jpg" className="w-full rounded-lg shadow-2xl" />
                    <div>
